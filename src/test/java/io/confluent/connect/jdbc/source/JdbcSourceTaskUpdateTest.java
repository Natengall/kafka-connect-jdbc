...
public class JdbcSourceTaskUpdateTest extends JdbcSourceTaskTestBase {
  ...
  public void testTimestamp() throws Exception {
    ...
    db.createTable(SINGLE_TABLE_NAME,
                   ...
                   "id", "INT");
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(10L)), "id", 1);
    ...
    // IDs 3 & 4.
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(10L)), "id", 2);
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(11L)), "id", 3);
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(12L)), "id", 4);
  ...
  public void testTimestampAndIncrementing() throws Exception {
    ...
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(10L)), "id", 3);
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(11L)), "id", 1);
  ...
  public void testTimestampAndIncrementingRestoreOffset() throws Exception {
    ...
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(9L)), "id", 2);
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(10L)), "id", 3);
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(11L)), "id", 4);
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(12L)), "id", 5);
    db.insert(SINGLE_TABLE_NAME, "modified", JdbcUtils.formatEST(new Timestamp(13L)), "id", 1);
